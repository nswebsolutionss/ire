...
#define CONFIGURE_ARGS " '--prefix' '/Users/steviehubble/Workspace/internationalRealEstate/opt/pgsql'"
...
#define PG_VERSION_STR "PostgreSQL 15.6 on x86_64-apple-darwin23.2.0, compiled by Apple clang version 15.0.0 (clang-1500.3.9.4), 64-bit"
