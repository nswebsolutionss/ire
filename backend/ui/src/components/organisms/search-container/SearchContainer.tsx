...
import { Label, Text, Box } from '../../atoms';
        ...
        <Box contentJustification='center' contentAlignment='start' width='90%' height='100%'>
          ...
          <SearchBarContainer contentDirection='row' width='100%' contentJustification='space-between'>
            ...
            <SearchButtonReactive>
                <Button marginL='5px' marginR='5px' width='100px' borderRadius='7px' height='45px' backgroundColor='#80ABB1' contentAlignment='center' contentJustification='center' color='white' fontWeight='500' onClick={() => navigate('/property-for-sale')}>
                    <Text>Sale</Text>
                </Button>
